...
const Setting = ({ Styles, FetchStyles }: any) => {
    ...
    // const [StyleCard, setStyleCard] = useState<any>([
    //     { slot: 1, StyleName: "", Image: "", File: null as null | File },
    //     { slot: 2, StyleName: "", Image: "", File: null as null | File },
    //     { slot: 3, StyleName: "", Image: "", File: null as null | File },
    //     { slot: 4, StyleName: "", Image: "", File: null as null | File },
    // ]);
    ...
    //         StyleCard.forEach((Card:any, index:any) => {
    //             let slotNum = index + 1;
    //             formData.append(`slot${slotNum}_Name`, Card.StyleName);
    //             if (Card.File instanceof File) {
    //                 formData.append(`slot${slotNum}_Image`, Card.File);
    //             }
    //         })
    //         const res = await API.put("/products/HomeStyles", formData);
    //         if (res.data) {
    //             showSuccessToast("Styles saved successfully!");
    //         }

    //     } catch (error) {
    //         showErrorToast("Failed to save styles");
    //     } finally {
    //         setSaving(false);
    //     }
    // };
