...
const ProductDetail = () => {
    ...
    return (
        <div className="w-full min-h-screen bg-white p-7 lg:p-10 flex flex-col">

            { /*BreadCrumbs*/}
            <div className="w-full flex px-5 pb-3 lg:px-50 justify-start text-text lg:text-sm text-[12px] lg:gap-2 gap-1 ">
                <Link to={"/"}>
